...
public class Locationdata extends AppCompatActivity {
    ...
    Button btn_addwork;
    List<LocationDetail> shelterinMainBeanList;
    LocationdataAdapter shelterAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callLocationdata(GlobalDeclaration.shelterid);
    }
    private void callLocationdata(String shelterid) {
        ...
        call.enqueue(new Callback<ShelterinMainBean>() {
            ...
            public void onResponse(Call<ShelterinMainBean> call, Response<ShelterinMainBean> response) {
                ...
                try {
                    ...
                    if (body.getLocationDetails().size()>0) {
                        shelterinMainBeanList = body.getLocationDetails();
                        final LinearLayoutManager layoutManager = new LinearLayoutManager(getApplicationContext());
                        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                        rv_workinitiationlist.setLayoutManager(layoutManager);
                        shelterAdapter = new LocationdataAdapter(shelterinMainBeanList, getApplicationContext(), Locationdata.this);
    ...
    private void showResponseAlert() {
        android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(Locationdata.this);
