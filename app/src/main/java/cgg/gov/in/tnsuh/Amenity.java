...
public class Amenity extends AppCompatActivity {

    RecyclerView rv_workinitiationlist;
    Button btn_addwork;
    List<AmenityDetail> shelterinMainBeanList;
    AmenityAdapter shelterAdapter;
            ...
            public void onResponse(Call<ShelterinMainBean> call, Response<ShelterinMainBean> response) {
                ...
                try {
                    ...
                    if (body.getAmenityDetails().size()>0) {
                        shelterinMainBeanList = body.getAmenityDetails();
                        final LinearLayoutManager layoutManager = new LinearLayoutManager(getApplicationContext());
                        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                        rv_workinitiationlist.setLayoutManager(layoutManager);
                        shelterAdapter = new AmenityAdapter(shelterinMainBeanList, getApplicationContext(), Amenity.this);
    ...
    private void showResponseAlert() {
        android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(Amenity.this);
