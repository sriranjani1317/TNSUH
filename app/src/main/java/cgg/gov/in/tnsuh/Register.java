...

{
    ...
    Button btn_addwork;
    List<RegisterDetail> shelterinMainBeanList;
    RegisterAdapter shelterAdapter;
            ...
            public void onResponse(Call<ShelterinMainBean> call, Response<ShelterinMainBean> response) {
                ...
                try {
                    ...
                    if (body.getRegisterDetails().size()>0) {
                        shelterinMainBeanList = body.getRegisterDetails();
                        final LinearLayoutManager layoutManager = new LinearLayoutManager(getApplicationContext());
                        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                        rv_workinitiationlist.setLayoutManager(layoutManager);
                        shelterAdapter = new RegisterAdapter(shelterinMainBeanList, getApplicationContext(), Register.this);
    ...
    private void showResponseAlert() {
        android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(Register.this);
