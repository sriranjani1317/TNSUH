...
public class GPSTracker extends Service implements LocationListener {
  ...
  //  private static final long MIN_TIME_BW_UPDATES = 1000 * 60 * 1; // 1 minute
            ...
            if (ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(mContext, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                if (!isGPSEnabled && !isNetworkEnabled) {
                    ...
                    if (isNetworkEnabled) {
                        ...
                        Log.e("my_Network", "Network");
                        if (locationManager != null) {
                            Log.e("my_Network123", "before");

                            location = locationManager.getLastKnownLocation(LocationManager.NETWORK_PROVIDER);
                            Log.e("my_Network123", "after");
                    ...
                    if (isGPSEnabled) {
                        if (location == null) {
                            ...
                            Log.e("my_GPSEnabled", "GPS Enabled");
                            if (locationManager != null) {
                                Log.e("my_Network1234", "before");

                                location = locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER);
                                Log.e("my_Network1234", "after");
    ...
    public double getLatitude() {
        if (location != null) {
            latitude = location.getLatitude();
            Log.e("my_latitude",""+latitude);
        }
        else {
            Log.e("my_latitude",""+"not aval");
    ...
    public double getLongitude() {
        if (location != null) {
            longitude = location.getLongitude();
            Log.e("my_longitude",""+longitude);

        }
        else {
            Log.e("my_longitude",""+"not aval");
